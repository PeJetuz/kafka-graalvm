...
final class KafkaProtoTestIT {
    ...
    void test() throws InterruptedException {
        ...
        Channel<TestOuter.Message> toKafka =
            this.createToKafkaChannel(KafkaProtobufSerializerTestMsg.class);
        ...
        // channel -> connector mapping is automatic when using KafkaConnector.configBuilder()
        Channel<TestOuter.Message> fromKafka = this.createFromKafkaChannel(
    ...
    private<T> Channel<T> createFromKafkaChannel(final String desClassName,
    ...
    private <T> Channel<T> createToKafkaChannel(final Class<? extends Serializer<T>> serializer) {
        return Channel.<T>builder()
